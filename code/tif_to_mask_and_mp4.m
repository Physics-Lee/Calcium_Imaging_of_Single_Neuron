...
if is_test
    start_frame = 12000;
    end_frame = 12300;
    video_name_str_red = sprintf('%s_size_%d_std_%d_sense_%.4f___disk_%d___from_%d_to_%d.mp4',...
        algorithm_type,G_size,G_std,sense_red,disk_size,start_frame,end_frame);
    video_name_str_green = sprintf('%s_size_%d_std_%d_sense_%.4f___disk_%d___from_%d_to_%d.mp4',...
